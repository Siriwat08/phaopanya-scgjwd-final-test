...
หลังจากแก้ไข Critical Issues ทั้ง 8 รายการแล้ว ได้ดำเนินการตรวจสอบช่องโหว่ด้านความปลอดภัยและแก้ไขเพิ่มเติมอีก 7 รายการ (ปัจจุบัน V5.5.016 เป็นเวอร์ชันที่ปล่อยแล้ว — APP_VERSION = '5.5.016'):
