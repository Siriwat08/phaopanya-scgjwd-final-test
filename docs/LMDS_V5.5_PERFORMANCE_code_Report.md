...
หลังจาก Performance Fix Cycle เสร็จสิ้น ได้ดำเนินการ Security Audit และแก้ไขช่องโหว่เพิ่มเติม 7 รายการ (ปัจจุบัน V5.5.015 เป็นเวอร์ชันที่ปล่อยแล้ว — APP_VERSION = '5.5.015'):
