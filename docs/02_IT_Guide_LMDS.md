...
| SCHEMA_VERSION | 5.5.004 | เวอร์ชัน Schema ปัจจุบัน |
...
>
> **เวอร์ชันเอกสาร:** 1.2 (ปรับปรุงตามโค้ดจริง V5.5.004) | **วันที่:** มิถุนายน 2569
>
> **✅ หมายเหตุ — เวอร์ชันซิงค์แล้ว:**
>
> 1. **APP_VERSION ในโค้ด = `5.5.004`** — ตรงกันกับ System Guide แล้ว (ความแตกต่างเดิมระหว่าง 5.5.001 และ V5.5.003 ได้รับการแก้ไขแล้ว)
