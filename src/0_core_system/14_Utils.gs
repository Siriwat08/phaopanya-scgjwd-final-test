 ...
 *     - [SEC-002 (setupAdminList_UI + AuthZ guard)]
 *     - [SEC-007 (maskReviewerEmail_ + inline fallback in isAuthorizedUser_ logs)]
 *     - [SEC-008 (hide admin email list + YES_NO confirmation before clear)]
